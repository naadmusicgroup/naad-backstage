...
<template>
  <DropdownMenuPortal>
    <DropdownMenuContentPrimitive
      ...
      :class="cn('surface-menu app-dropdown-menu-content z-[70] min-w-36 overflow-x-hidden overflow-y-auto rounded-lg border p-1.5 text-popover-foreground outline-none will-change-[opacity,transform] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2', props.class)"
    >
      <slot />
    </DropdownMenuContentPrimitive>
  </DropdownMenuPortal>
