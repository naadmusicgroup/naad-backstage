...
export interface UpdateTrackInput {
  ...
  containsAiGeneratedElements?: boolean | null
  status?: TrackStatus
  confirmArchiveWithEarnings?: boolean
}
...
export interface AdminArchiveRiskTrack {
  id: string
  title: string
  isrc: string
  versionLine: string | null
  status: TrackStatus
  earningsRowCount: number
  earningsTotal: string
}

export interface AdminArchiveRiskResponse {
  scope: "release" | "track"
  releaseId: string
  releaseTitle: string
  releaseUpc: string | null
  trackId: string | null
  tracks: AdminArchiveRiskTrack[]
  earningsRowCount: number
  earningsTotal: string
  affectedUploadCount: number
  hasEarnings: boolean
}
