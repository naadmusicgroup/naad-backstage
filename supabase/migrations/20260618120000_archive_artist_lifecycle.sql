create or replace function public.admin_archive_artist(
...
revoke all on function public.admin_archive_artist(uuid, uuid) from public, anon, authenticated;
grant execute on function public.admin_archive_artist(uuid, uuid) to service_role;

drop function if exists public.admin_orphan_artist(uuid, uuid);
